...
public class ItemWorldOreKiller extends Item {
    ...
    public ItemWorldOreKiller() {
        setUnlocalizedName(BTStrings.MOD_ID + "_" + BTStrings.oreKillerName);
        GameRegistry.registerItem(this, BTStrings.oreKillerName);
        setCreativeTab(CreativeTabs.tabMaterials);
        setTextureName(BTStrings.MOD_ID + ":" + BTStrings.oreKillerName);
    }
