...
public class Foodstuffs implements IGameEditor {
    ...
    public void apply() {
        ...
        util.removeRecipeByOutput(Items.cake);
        ...
        util.removeRecipeByOutput(Items.bread);
        ...
        util.removeSmeltingRecipeByOutput(Items.bread);
        ...
        // Misc. drying recipes
        Item jerky = GameRegistry.findItem("TConstruct", "jerky");
