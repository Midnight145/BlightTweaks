...
public class AWDisableChiselCompatEditor implements IAsmEditor {
	...
	@Override
	public String getClassName() { return "WayofTime.alchemicalWizardry.common.bloodAltarUpgrade.CompatChecks"; }

	@Override
	public String getMethodName() { return "checkChiselBlock"; }

	@Override
	public String getMethodDesc() { return "(LWayofTime/alchemicalWizardry/api/BlockStack;Ljava/lang/String;)Z"; }
